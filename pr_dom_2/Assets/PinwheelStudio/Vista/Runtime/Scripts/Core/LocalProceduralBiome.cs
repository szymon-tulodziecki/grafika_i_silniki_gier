...
namespace Pinwheel.Vista
{
    ...
    public class LocalProceduralBiome : MonoBehaviour, IProceduralBiome, ISerializationCallbackReceiver
    {
        ...
        public int baseResolution
        {
            ...
            set
            {
                m_baseResolution = Utilities.MultipleOf8(Mathf.Clamp(value, Constants.RES_MIN, 0x200));
            }
        }
        ...
        public int biomeMaskResolution
        {
            ...
            set
            {
                ...
                int newRes = Utilities.MultipleOf8(Mathf.Clamp(value, Constants.RES_MIN, 0x200));
                if (oldRes != newRes)
                {
