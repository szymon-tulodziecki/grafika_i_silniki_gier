...
namespace Pinwheel.Vista
{
    ...
    public class VistaManager : MonoBehaviour
    {
        ...
        public int heightMapResolution
        {
            ...
            set
            {
                m_heightMapResolution = Mathf.Clamp(Mathf.ClosestPowerOfTwo(value) + 1, Constants.HM_RES_MIN, 0x201);
            }
        }
        ...
        public int textureResolution
        {
            ...
            set
            {
                m_textureResolution = Mathf.Clamp(Mathf.ClosestPowerOfTwo(value), Constants.HM_RES_MIN, 0x201);
            }
        }
        ...
        public int detailDensityMapResolution
        {
            ...
            set
            {
                m_detailDensityMapResolution = Mathf.Clamp(Mathf.ClosestPowerOfTwo(value), Constants.RES_MIN, 0x200);
            }
        }
